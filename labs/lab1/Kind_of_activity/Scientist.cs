...
namespace lab1.Kind_of_activity
{
    public class Scientist : Human
    {
        ...
        protected Scientist() => Console.WriteLine("Constructor Scientist() by default was called at {0}",
            DateTime.Now.ToLongTimeString());

        protected Scientist(string academicRank, string faculty)
        {
            Console.WriteLine("Auto-generated constructor Scientist() was called at {0}",
                DateTime.Now.ToLongTimeString());
            _academicRank = academicRank;
            _faculty = faculty;
        }

        protected Scientist(double weight, int age, string name, Image image, string academicRank, string faculty) :
            base(weight, age, name, image)
        {
        ...
        private Scientist(double weight, int age, string name, string fileName, string academicRank, string faculty) :
